...
public class Adapter extends BaseAdapter {
    ...
    public Adapter(Context mContext, ArrayList<String> array_mountain) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.activity_adapter, parent, false);
